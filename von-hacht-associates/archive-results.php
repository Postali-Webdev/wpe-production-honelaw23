    ...
    <div class="grid-container">
        ...
        <div class="cell row1">
            ...
            <ul class="team-tab-list about-tab-list">
                <li class="team-tab-li open"><a href="/results/">All</a></li>
                <?php foreach( $results_categories as $result ) : $count++; ?>
                    <li class="team-tab-li"><a href="/blog/result_category/<?php echo $result->slug; ?>"><?php echo $result->cat_name; ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        <?php endif; ?>
